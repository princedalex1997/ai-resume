...
const analysisValidater = z.object({
  ...
  issues: z
    ...
    .length(5, "Exactly 5 issues required"),
  ...
  strengths: z
    ...
    .length(5, "Exactly 5 strengths required"),
  ...
  bulletRewrites: z
    ...
    .min(5, "At least 5 rewrites required"),

  keywordsPresent: z.array(z.string()),

  keywordsMissing: z.array(z.string()),

  summary: z.string().min(20, "Summary must contain meaningful text"),
});
