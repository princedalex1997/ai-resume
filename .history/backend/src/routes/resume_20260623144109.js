...
router.post(
  ...
  asyncHandler(async (req, res) => {
    console.time("loadResume");
    const resume = await loadOwnResume(req);
    console.timeEnd("loadResume");
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    console.log(analysis.bulletRewrites);
